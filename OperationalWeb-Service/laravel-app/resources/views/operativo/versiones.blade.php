        ...
        <div class="glass-panel rounded-[24px] overflow-hidden shadow-xl">
            ...
            <div class="px-6 py-4 border-t border-slate-200 dark:border-white/5 flex items-center justify-between flex-wrap gap-4">
                <div class="flex items-center gap-4 text-xs text-slate-500">
                    ...
                    @endif
                    @if(!empty($aprobada['metadata']['approved_at']))
                        <div class="flex items-center gap-1.5">
                            ...
                            <span class="text-[10px] text-slate-400 font-medium">
                                Aprobado el {{ \Carbon\Carbon::parse($aprobada['metadata']['approved_at'])->format('d/m/Y') }}
                            </span>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mt-1">
                             ...
                             @if(!empty($version['metadata']['approved_at']))
                                <div class="flex items-center gap-1.5 mt-1.5">
                                    <svg class="w-3 h-3 text-slate-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                    </svg>
                                    <span class="text-[10px] text-slate-400 font-medium">
                                         {{ \Carbon\Carbon::parse($version['metadata']['approved_at'])->format('d/m/Y') }}
                                    </span>
                                </div>
                            @endif
                            </div>
